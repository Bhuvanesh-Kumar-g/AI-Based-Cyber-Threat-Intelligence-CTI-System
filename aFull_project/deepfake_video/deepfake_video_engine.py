...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'deepfake_audio')))
from deepfake_audio_engine import analyze_audio

MODEL_PATH = os.path.join(os.path.dirname(__file__), 'ULTIMATE_CHAMPION_model.pth')
